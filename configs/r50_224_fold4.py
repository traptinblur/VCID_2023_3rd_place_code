...
class CFG:
    ...
    loss_weights = [1, 0]
    p_mixup = 0.1
    p_switch = 0.  # switch mixup to cutmix
    rotate_limit = 180
    ...
    # ============== fold =============
    folds = [4]  # specify which fold needs experiment on
    ...
    train_aug_list = [
        ...
        A.ShiftScaleRotate(rotate_limit=rotate_limit, p=p_shiftscalerotate),
        A.OneOf([
